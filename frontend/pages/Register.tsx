...
const Register = () => {
  ...
  const handleSocialLogin = async (provider: 'google' | 'github') => {
    ...
    try {
      const result = provider === 'google' ? await googleLogin() : await githubLogin();
      if (result.isNewUser) {
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <h2 className="text-4xl font-bold text-white mb-2">Join CodeClash</h2>
        ...
        <div className="bg-gray-800 border border-cyan-500/30 rounded-lg p-8">
          ...
          <div className="space-y-3 mb-6">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 bg-white text-gray-800 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            <button
              ...
              disabled={!!socialLoading || loading}
              className="w-full flex items-center justify-center gap-3 bg-gray-900 border border-gray-600 text-white py-3 rounded-lg font-semibold hover:bg-gray-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
